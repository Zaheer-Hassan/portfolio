...
export const projects: Project[] = [
  {
    ...
    subServices: [
      { title: "Video Pipeline", description: "AI script generation, Edge TTS voiceover, Pexels B-roll, FFmpeg assembly with karaoke subtitles." },
      { title: "Cartoon Engine", description: "Remotion-based React video composition with AI-generated images via Replicate Flux." },
      { title: "Platform Features", description: "BullMQ job queue, scheduled auto-publishing, YouTube Shorts, multi-user RBAC, cost tracking." },
    ],
  },
  {
    id: 2,
  ...
  },
  {
    ...
    role: "Full-Stack Developer",
    contribution: "Built the custom payment routing engine that dynamically selects the optimal payment provider based on card BIN, country, and transaction history. The main challenge was implementing the ML-based fraud scoring system that learns from transaction patterns — the more it processes, the smarter it gets at detecting suspicious activity. Also built the automated reconciliation system that matched transactions across multiple providers.",
  ...
  },
  {
    ...
    role: "Full-Stack Developer",
    contribution: "Architected the dynamic reporting engine that allows merchants to customize invoice and report fields without code changes. The biggest challenge was building the multi-gateway data center — aggregating transaction data from different payment providers with varying data formats into a unified view. Built the Xero integration for automated accounting sync and designed the role-based access system supporting complex organizational hierarchies.",
  ...
  },
  {
    ...
    role: "Backend Developer",
    contribution: "Developed the NFT Flow-based chargeback solution — the core innovation. The previous LTC-based flow was taking 5-6 minutes per transaction. I architected a new approach using NFT transfers to random wallets, bringing delivery time down to under 1 minute. Also built the rate limiting system to handle 100K+ transactions/month and implemented comprehensive logging with Slack alerts for real-time production monitoring.",
  ...
  },
  {
    ...
    subServices: [
      { title: "Payment Flow", description: "Built scalable backend for secure transaction processing with external system integrations." },
      { title: "KYC Microservice", description: "Identity verification module supporting multiple KYC vendors under a unified ledger." },
      { title: "Back-Office", description: "Financial accounting, transaction monitoring, and user management modules." },
    ],
  },
  {
    id: 8,
  ...
  },
  {
    ...
    role: "Full-Stack Developer",
    contribution: "Developed the Chrome extension architecture that injects AI analysis directly into trading platforms. The challenge was building real-time chart pattern recognition that runs efficiently in the browser without lag. Implemented the auto-investment feature that executes trades based on AI confidence scores, with safety limits and withdrawal timing alerts to protect users from volatile market swings.",
